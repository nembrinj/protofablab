...
void setup() {
  ...
  while(verifyIfSet() == false){
    ...
    Serial.println("You need to setup the level 1 2 and 3.");
    // thing.sendMsg("+40770130157", "You need to setup the level 1 2 and 3. Sent from Twilio.");
